...
class SteamClient:
    ...
    def get_my_inventory(self, game: GameOptions, merge: bool = True, count: int = 5000) -> dict:
        ...
        return self.get_partner_inventory(steam_id, game, merge=merge, count=count)
    ...
    def accept_trade_offer(self, trade_offer_id: str) -> dict | None:
        ...
        if response.get('needs_mobile_confirmation', False):
            response.update(self._confirm_transaction(trade_offer_id))
        return response
    ...
    def make_offer(self, items_from_me: List[Asset], items_from_them: List[Asset], partner_steam_id: str,
        ...
        params = {
            ...
            'captcha': '',
            'trade_offer_create_params': {"trade_offer_access_token": partner_account_id},
